package id.ojam.javaproject.controller;
...
import id.ojam.javaproject.model.Agency;
import id.ojam.javaproject.model.ERole;
import id.ojam.javaproject.model.Role;
import id.ojam.javaproject.model.User;
import id.ojam.javaproject.payload.request.SignupCustomRequest;
import id.ojam.javaproject.payload.request.UserCustomRequest;
import id.ojam.javaproject.payload.request.UserPasswordRequest;
import id.ojam.javaproject.payload.response.MessageResponse;
import id.ojam.javaproject.repository.AgencyRepository;
import id.ojam.javaproject.repository.RoleRepository;
import id.ojam.javaproject.repository.UserRepository;
import id.ojam.javaproject.security.jwt.JwtUtils;
